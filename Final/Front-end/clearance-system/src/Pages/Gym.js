...
import Img2 from "../Images/gym3.png";
    ...
    <div style={backgroundImageStyle}>
      ...
      <div >
        ...
        <div style={noticeBoardStyle}>
          ...
          <div style={cardStyle}><h3><center>Event</center></h3><br/><h6><center>The Colors Awarding Ceremony and Colors Night is to be scheduled on 17th September 2024 at the EOE Pereira Theater.</center></h6></div>
          ...
          <div style={cardStyle}><h3><center>Gymnasium </center></h3><br/><h6><center>University of Peradeniya Gymnasium is a large indoor complex equipped with top –class sports training facilities.</center></h6></div>
        </div>
      </div>
    </div>
  );
